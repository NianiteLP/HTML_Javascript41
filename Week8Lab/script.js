...
gameStates[2] = function(){
    ...
    ctx.fillText("Your New High Score is: " + highScore.toString(), c.width / 2, c.height / 2 - 25);
    ctx.fillText("New Record!" , c.width / 2, c.height / 2+10);
    ctx.font = "15px Arial";
    ctx.fillText("Press Enter to Retry", c.width / 2, c.height / 2 + 50);
    ctx.restore();
    }
    else{
          ctx.save();
    ...
    ctx.textAlign = "center";
    ctx.fillText("Game Over, Your Score Was: " + score.toString(), c.width / 2, c.height / 2 - 60);
    ctx.fillText("Your High Score is: " + highScore.toString(), c.width / 2, c.height / 2 - 25);
    ctx.font = "15px Arial";
    ctx.fillText("Press Enter to Retry", c.width / 2, c.height / 2 + 20);
    ctx.restore();
    }
